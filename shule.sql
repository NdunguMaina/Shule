...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 10, 2022 at 07:39 PM
...
('Kamau Mwangi', 1, 'CLASS 1', 78, 90, 98, 79, 87, 432, 86.4);
...
('Kamau Mwangi', 1, 'CLASS 1'),
('Peter Otieno', 2, 'CLASS 2'),
('mark otieno', 3, 'CLASS 3'),
('john kile', 4, 'CLASS 4'),
('mary mwate', 5, 'CLASS 5'),
('james njane', 6, 'CLASS 6'),
('peter mwangi', 7, 'CLASS 7'),
('jane jemi', 8, 'CLASS 8');
